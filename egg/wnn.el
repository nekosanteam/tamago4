...
(egg-add-message
 '((nil
   ...
   (Chinese-GB
    (wnn-connect-error  "不能和server连接")
    (wnn-fail-make-env  "环境不能创建")
    (wnn-dict-saving    "%s 的频度文件和辞典信息正在退出")
    (wnn-dict-saved     "%s 的频度文件和辞典信息已经退出了")
    (wnn-dir-missing    "目录 %s 没有。要建立吗? ")
    (wnn-dir-failed     "目录 %s 建立失败了")
    (wnn-dir-created    "目录 %s 建立了")
    (wnn-dict-missing-1 "字典文件 %s 没有: %s")
    (wnn-dict-missing-2 "字典文件 %s 没有。要建立吗? ")
    (wnn-dict-created   "字典文件 %s 建立了")
    (wnn-freq-missing-1 "频度文件 %s 没有: %s")
    (wnn-freq-missing-2 "频度文件 %s 没有。要建立吗? ")
    (wnn-freq-created   "频度文件 %s 建立了")
    (wnn-no-match       "字典和频度 %s 的整合性没有。要再建立吗? ")
    (wnn-re-create-freq "频度文件 %s 再建立了")
    (wnn-pseud-bunsetsu "疑似文节")
    (wnn-register-1     "登录辞典名:")
    (wnn-register-2     "词性名")
    (wnn-no-writable-d  "没有可能登录的辞典"))
   (Chinese-CNS
    (wnn-connect-error  "不能和server連接")
    (wnn-fail-make-env  "環境不能創建")
    (wnn-dict-saving    "%s 的頻度文件和辭典信息正在退出")
    (wnn-dict-saved     "%s 的頻度文件和辭典信息已經退出了")
    (wnn-dir-missing    "目錄 %s 沒有。要建立嗎? ")
    (wnn-dir-failed     "目錄 %s 建立失敗了")
    (wnn-dir-created    "目錄 %s 建立了")
    (wnn-dict-missing-1 "字典文件 %s 沒有: %s")
    (wnn-dict-missing-2 "字典文件 %s 沒有。要建立嗎? ")
    (wnn-dict-created   "字典文件 %s 建立了")
    (wnn-freq-missing-1 "頻度文件 %s 沒有: %s")
    (wnn-freq-missing-2 "頻度文件 %s 沒有。要建立嗎? ")
    (wnn-freq-created   "頻度文件 %s 建立了")
    (wnn-no-match       "字典和頻度 %s 的整和性沒有。要再建立嗎? ")
    (wnn-re-create-freq "頻度文件 %s 再建立了")
    (wnn-pseud-bunsetsu "疑似文節")
    (wnn-register-1     "登錄辭典名:")
    (wnn-register-2     "詞性名")
    (wnn-no-writable-d  "沒有可能登錄的字典"))
   (Korean
    (wnn-connect-error  "서버(Server) 와 접촉할 수 없읍니다")
    (wnn-fail-make-env  "환경을 작성할 수 없읍니다")
    (wnn-dict-saving    "%s 의 빈도정보와 사전정보를 세이브하고 있습니다")
    (wnn-dict-saved     "%s 의 빈도정보와 사전정보를 세이브했습니다")
    (wnn-dir-missing    "디렉토리 %s 이 없읍니다．작성하겠습니까? ")
    (wnn-dir-failed     "디렉토리 %s 을 작성할 수 없읍니다")
    (wnn-dir-created    "디렉토리 %s 을 작성했습니다")
    (wnn-dict-missing-1 "사전화일 %s 이 없읍니다: %s")
    (wnn-dict-missing-2 "사전화일 %s 이 없읍니다．다시 작성하겠습니까? ")
    (wnn-dict-created   "사전화일 %s 을 작성했습니다")
    (wnn-freq-missing-1 "빈도화일 %s 이 없읍니다: %s")
    (wnn-freq-missing-2 "빈도화일 %s 이 없읍니다．다시 작성하겠습니까? ")
    (wnn-freq-created   "빈도화일 %s 을 작성했습니다")
    (wnn-no-match       "사전과 빈도 %s 가 맞지 않습니다．다시 작성하겠습니까? ")
    (wnn-re-create-freq "빈도화일 %s 을 다시 작성했습니다")
    (wnn-pseud-bunsetsu "의사문절")
    (wnn-register-1     "등록사전명:")
    (wnn-register-2     "품사명")
    (wnn-no-writable-d  "등록 가능한 지정이 아닙니다"))))

